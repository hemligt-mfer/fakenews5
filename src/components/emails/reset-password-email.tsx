...
export const ResetPasswordEmail = ({ url }: VerifyEmailProps) => (
  <Tailwind
    config={{
              ...
              <Section className="mobile:px-6! px-10 pt-8">
                <Section className="mb-9">
                  ...
                  <Text className="text-[14px] text-black">
                    Someone recently requested a password reset for your Daily
                    Commit account. If this was you, you can set a new password
                    here:
                  </Text>

                  <Text className="text-[14px] font-sans text-muted-foreground mt-4">
