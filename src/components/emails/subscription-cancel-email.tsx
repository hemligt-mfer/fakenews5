...
interface SubscriptionCancelledUser {
  name: string;
  email: string;
}

interface SubscriptionCancelledPlanProps {
  name: string;
  priceId?: string;
...
interface SubscriptionCancelledProps {
  user: SubscriptionCancelledUser;
  plan: SubscriptionCancelledPlanProps;
}
            ...
            <Section className="bg-card border-border rounded-1xl border">
              ...
              <Section className="mobile:px-6! px-10 pt-8">
                <Section className="mb-9">
                  ...
                  <Text className="text-[14px] font-sans text-muted-foreground m-0 mt-4.5">
                    You can restore or manage your subscription at any time from
              ...
              <Section className="mobile:px-6! px-10 pt-16 pb-8">
                <Text className="text-[11px] font-sans text-muted-foreground m-0 max-w-77.5">
                  If you didn&apos;t request this cancellation, please contact
